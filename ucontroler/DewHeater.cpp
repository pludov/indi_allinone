...
DewHeater::DewHeater(MeteoTemp * meteoTemp, uint8_t pin, uint8_t pwmPin, int suffix, uint32_t eepromAddr)
    ...
    oneWire(pin)
{
    ...
    IndiVectorMemberStorage::remember(&settingKp, EepromStored::Addr(eepromAddr, 125));
    IndiVectorMemberStorage::remember(&settingKi, EepromStored::Addr(eepromAddr, 126));
    IndiVectorMemberStorage::remember(&settingKd, EepromStored::Addr(eepromAddr, 127));
