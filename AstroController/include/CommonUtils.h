...
#define DEBUG7(A, B, C, D, E, F, G) { debugItem(A);debugItem(B);debugItem(C);debugItem(D);debugItem(E);debugItem(F);debugItem(G);   SerialDbg.write('\r');SerialDbg.write('\n');yield();}

#define GET_DEBUG_MACRO(_1,_2,_3,_4,_5,_6,_7, NAME,...) NAME
#define DEBUG(...) GET_DEBUG_MACRO(__VA_ARGS__, DEBUG7, DEBUG6, DEBUG5, DEBUG4, DEBUG3, DEBUG2, DEBUG1)(__VA_ARGS__)
